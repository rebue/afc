...
public class AfcTradeCtrl {
	...
	PageInfo<AfcTradeMo> list(AfcTradeMo mo, @RequestParam("pageNum") int pageNum,
		...
		PageInfo<AfcTradeMo> result = svc.list(mo, pageNum, pageSize, "TRADE_TIME desc");
	...
	PageInfo<AfcTradeMo> cashbackTradeList(AfcTradeMo mo, @RequestParam("pageNum") int pageNum,
			@RequestParam("pageSize") int pageSize) {
		_log.info("list AfcTradeMo:" + mo + ", pageNum = " + pageNum + ", pageSize = " + pageSize);
		if (pageSize > 50) {
			String msg = "pageSize不能大于50";
	...
	PageInfo<AfcTradeMo> balanceTradeList(AfcTradeMo mo, @RequestParam("pageNum") int pageNum,
			@RequestParam("pageSize") int pageSize) {
		_log.info("list AfcTradeMo:" + mo + ", pageNum = " + pageNum + ", pageSize = " + pageSize);
		if (pageSize > 50) {
			String msg = "pageSize不能大于50";
