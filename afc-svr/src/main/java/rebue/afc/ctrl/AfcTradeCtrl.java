...
import rebue.afc.ro.AfcTradeGetRo;
...
public class AfcTradeCtrl {
     ...
     */
    private final static Logger _log = LoggerFactory.getLogger(AfcTradeCtrl.class);
    ...
    Ro del(@RequestParam("id") java.lang.Long id) {        _log.info("save AfcTradeMo:" + id);
