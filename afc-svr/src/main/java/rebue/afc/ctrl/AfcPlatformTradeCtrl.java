...
import rebue.afc.ro.AfcPlatformTradeGetRo;
...
public class AfcPlatformTradeCtrl {
     ...
     */
    private final static Logger _log = LoggerFactory.getLogger(AfcPlatformTradeCtrl.class);
    ...
    Ro del(@RequestParam("id") java.lang.Long id) {        _log.info("save AfcPlatformTradeMo:" + id);
